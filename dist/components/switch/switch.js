...
var Switch = (_temp = _class = function (_React$Component) {
  ...
  _createClass(Switch, [{
    ...
    value: function render() {
      ...
      var _props = this.props,
          ...
          cls = (0, _classnames2.default)((_classNames = {}, _defineProperty(_classNames, "ui-switch", true), _defineProperty(_classNames, "jimu-switch-issmall", isSmall), _defineProperty(_classNames, "switch-open", isOpen && !isReader), _defineProperty(_classNames, "switch-open-move", isOpen && isReader), _defineProperty(_classNames, "switch-close", !isOpen && !isReader), _defineProperty(_classNames, "switch-close-move", !isOpen && isReader), _defineProperty(_classNames, "switch-disabled", disabled), _classNames));
  ...
  isOpen: false, // 展开状态
  clickBack: function clickBack() {}, // 点击回调函数
  isSmall: false, // 
