  ...
  _createClass(Bubble, [{
    ...
    value: function render() {
      ...
      var _state2 = this.state,
          ...
          align = _state2.align,
          cls = (0, _classnames2.default)((_classNames = {}, _defineProperty(_classNames, "jimu-bubble", true), _defineProperty(_classNames, 'jimu-bubble-' + direction, true), _defineProperty(_classNames, 'jimu-bubble-' + align, true), _defineProperty(_classNames, "jimu-bubble-close", closeBtnShow), _defineProperty(_classNames, className, className), _classNames));
