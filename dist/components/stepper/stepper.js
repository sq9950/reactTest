  ...
  _createClass(Stepper, [{
    ...
    value: function render() {
      var _props3 = this.props,
        ...
        "didi-stepper": true,
        "didi-stepper-disabled": disabled
      }, className, className)),
          prevCls = (0, _classnames2.default)({
        "didi-stepper-btn": true,
        "icon-jimu-artboard-reduce": true,
        "didi-stepper-btn-prev": true,
        "didi-stepper-disabled": defaultVal <= min
      }),
          nextCls = (0, _classnames2.default)({
        "didi-stepper-btn": true,
        "icon-jimu-artboard-add": true,
        "didi-stepper-btn-next": true,
        "didi-stepper-disabled": defaultVal >= max
      });

      return _react2.default.createElement(
        'div',
        { className: cls },
        _react2.default.createElement('span', { className: prevCls, onClick: this.prevClick.bind(this) }),
        _react2.default.createElement(
          'span',
          { className: 'didi-stepper-defaultval' },
          defaultVal
        ),
        _react2.default.createElement('span', { className: nextCls, onClick: this.nextClick.bind(this) })
      );
    }
  }]);
