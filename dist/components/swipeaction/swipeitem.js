...
var SwipeDel = (_temp = _class = function (_React$Component) {
  ...
  function SwipeDel(props) {
    ...
    return _possibleConstructorReturn(this, (SwipeDel.__proto__ || Object.getPrototypeOf(SwipeDel)).call(this, props));
  }

  _createClass(SwipeDel, [{
    key: 'initSetState',
    value: function initSetState(props) {
      var delAside = this.refs.delAside,
          delContent = this.refs.delContent,
          delSwipContent = this.refs.delSwipContent,
          show = props.show,
    ...
    value: function swipingLeft(e, posX) {
      var self = this,
          ...
          setPosx = oldPosX,
          _props = this.props,
          touchDefault = _props.touchDefault,
          displacement = _props.displacement;
    ...
    value: function setContState(pos, touchState) {
      var delContent = this.refs.delContent,
          oldPosX = this.state.oldPosX,
          _props2 = this.props,
          index = _props2.index,
          touchBack = _props2.touchBack,
          self = this;
    ...
    value: function render() {
      ...
      return _react2.default.createElement(
        'div',
        { className: cls, ref: 'delSwipContent' },
        _react2.default.createElement(
          Swipeable,
          { onSwipingLeft: this.swipingLeft.bind(this), onSwiped: this.swiped.bind(this) },
          _react2.default.createElement(
            'div',
            { className: 'del-content', ref: 'delContent' },
            children
          ),
          _react2.default.createElement(
            'div',
            { className: 'del-aside', ref: 'delAside' },
            this.renderButtons()
          )
        )
      );
