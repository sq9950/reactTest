      ...
      return _react2.default.createElement(
        ...
        _react2.default.Children.map(this.props.children, function (child, index) {
          if (disTouchs[index]) {
            return _react2.default.createElement(
              _swipeitem2.default,
              { key: index, index: index, buttons: buttons[index] || defaultButtons, show: shows[index], displacement: displacements[index], touchDefault: touchDefaults[index], touchDefaultBack: self._touchDefaultBack.bind(self), touchBack: self._touchBack.bind(self) },
              child
            );
          } else {
            return _react2.default.createElement(
