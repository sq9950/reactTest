...
var Code = (_temp = _class = function (_React$Component) {
  ...
  _createClass(Code, [{
    ...
    value: function render() {
      ...
      return _react2.default.createElement(
        ContentTip,
        { show: show, className: 'jimu-code-tip', MaskClick: this.closeClick.bind(this) },
        _react2.default.createElement(
          ...
          _react2.default.createElement(
            ...
            _react2.default.createElement('span', { className: 'code-icon-del icon-del', onClick: this.closeClick.bind(this) }),
            _react2.default.createElement(
              'h2',
              { className: 'hd-title' },
              '\u8BF7\u8F93\u5165\u624B\u673A\u9A8C\u8BC1\u7801'
          ...
          _react2.default.createElement(
            ...
            _react2.default.createElement(
              ...
              timer != 0 ? _react2.default.createElement(
                ...
                'span',
                { className: 'reset-code', onClick: this.reSetClick.bind(this) },
                '\u91CD\u65B0\u53D1\u9001'
              )
            ),
            _react2.default.createElement(
              'div',
              { className: 'jimu-code-inputs', onClick: this.focusClick.bind(this) },
              _react2.default.createElement(
                'label',
                null,
                _react2.default.createElement(
                ...
                _react2.default.createElement('input', { ref: 'codeInput', maxLength: len, type: inputType, className: 'code-input', onFocus: self.focusHandle.bind(self), onBlur: self.blurHandle.bind(self), onInput: self.changeHandle.bind(self), value: codeValue })
              )
            )
          )
        )
  ...
  timer: 30, // 倒计时
  inputBack: undefined, // 输入完成后的回调
  inputBegin: undefined, // 输入开始的回调
  closeBack: undefined, // 关闭后的回调
  resetBack: undefined, // 点击重新发送后的回调
  timeEndBack: undefined, // 点击重新发送后的回调
  inputType: "tel", // 小键盘类型
  len: 4, // 验证码数
