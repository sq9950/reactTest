    ...
    _createClass(SelectCar, [{
        ...
        value: function brandClick(obj) {
            ...
            fetch(brandDataURL + 'seriesprice-pm1-b' + obj.id + '-t16-v8.2.0.json').then(function (response) {
                ...
                // 其他车型 （海外、停售）
                otherlist.map(function (ele, index) {
                    arr = arr.concat(ele.serieslist);
                });
                self.setState({
                    carTypeShow: true,
        ...
        value: function render() {
            var _state2 = this.state,
                ...
                selectCity = _state2.selectCity,
                typeList = _state2.typeList,
            ...
            return _react2.default.createElement(
                ...
                _react2.default.createElement(_index2.default, {
                    ...
                    onTouchMove: carTypeShow && !showWrap ? this.brandTouchmove.bind(this) : null,
                    dataAttrName: carBrandDataAttrName,
                    callBack: this.brandClick.bind(this)
                }),
                _react2.default.createElement(_index4.default, {
                    show: carTypeShow,
                    listData: carTypeArr,
                    showWrap: showWrap,
                    onTouchMove: carColorShow && !showWrap ? this.carTypeTouchmove.bind(this) : null,
                    dataAttrName: carTypeDataAttrName,
                    width: '70',
                    onClick: this.carTypeClick.bind(this)
                }),
                _react2.default.createElement(_index4.default, {
                    width: '30',
                    show: carColorShow,
                    ...
                    onClick: this.carColorClick.bind(this)
                }),
                '}'
            );
        }
