...
var Sliders = (_temp = _class = function (_React$Component) {
  ...
  function Sliders(props) {
    ...
    return _possibleConstructorReturn(this, (Sliders.__proto__ || Object.getPrototypeOf(Sliders)).call(this, props));
  }

  _createClass(Sliders, [{
    key: 'componentDidMount',
    value: function componentDidMount() {
      var sliderTitles = this.refs.sliderTitles;
    ...
    value: function render() {
      ...
      return _react2.default.createElement(
        ...
        _react2.default.createElement(
          _slider2.default,
          _extends({}, others, { onChangeBack: this.changeBack.bind(this) }),
          _react2.default.createElement('div', { className: 'slider-title', ref: 'sliderTitles' })
        )
      );
    }
  }]);
  ...
  onChangeBack: function onChangeBack() {}, // 获取子元素值 会触发 onChange 事件，并把改变后的值作为参数传入
  upChangeBack: function upChangeBack() {}, // 向父元素传值 会触发 onChange 事件，并把改变后的值作为参数传入
  titleBefore: "我愿意自费",
  titleAfter: "元升舱叫车"
}, _temp);
