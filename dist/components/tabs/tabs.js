...
var Tabs = (_temp = _class = function (_React$Component) {
  ...
  _createClass(Tabs, [{
    ...
    value: function setTabHdX(activeIndex) {
      var tabsHd = this.refs.tabsHd,
          NavNode = this.refs['tabsNav-' + activeIndex],
    ...
    value: function renderTabNav() {
      ...
      return _react2.default.createElement(
        'div',
        { className: 'didi-tabs-hd', ref: 'tabsHd' },
        _react2.default.Children.map(children, function (child, i) {
          ...
          var navCls = (0, _classnames2.default)({
            "didi-tabs-nav": true,
            "didi-tabs-nav-active": i == activeIndex - 1
          });
          return _react2.default.createElement(
            'div',
            { className: navCls, key: i, ref: 'tabsNav-' + (i + 1), onClick: self.handleTabClick.bind(_this2, i + 1) },
            _react2.default.createElement(
              'b',
              { className: 'didi-tabs-nav-bar' },
              child.props.tab
            )
          );
        })
    ...
    value: function renderTabContent() {
      ...
      return _react2.default.createElement(
        'div',
        { className: 'didi-tabs-bd' },
        _react2.default.Children.map(children, function (child, i) {
          if (!child) {
            return;
          }
          var contentCls = (0, _classnames2.default)({
            "didi-tabs-content": true,
            "didi-tabs-content-active": i == activeIndex - 1
          });
          return _react2.default.createElement(
            'div',
