...
var NoticeBar = (_temp = _class = function (_React$Component) {
  ...
  _createClass(NoticeBar, [{
    ...
    value: function componentDidMount() {
      var _props = this.props,
          ...
          _refs = this.refs,
          messageRoot = _refs.messageRoot,
          messageItemsRoot = _refs.messageItemsRoot,
    ...
    value: function latMove() {
      var self = this,
          ...
          _refs2 = this.refs,
          messageRoot = _refs2.messageRoot,
          messageItemsRoot = _refs2.messageItemsRoot,
          msgWidth = messageRoot.clientWidth,
          itemsWidth = messageItemsRoot.clientWidth,
    ...
    value: function latMoving(left) {
      var messageItemsRoot = this.refs.messageItemsRoot;
    ...
    value: function rollMove() {
      var self = this,
          ...
          messageItemsRoot = this.refs.messageItemsRoot,
          mySpeed = speed > 10 ? 10 : speed;
      // 如果子元素个数为一时 ，不滚动
      if (message.length <= 1) {
        return;
    ...
    value: function rollMoveing(idx) {
      var self = this,
          _refs3 = this.refs,
          messageItemsRoot = _refs3.messageItemsRoot,
          messageRoot = _refs3.messageRoot;
    ...
    value: function render() {
      ...
      var cls = (0, _classnames2.default)(_defineProperty({
        "didi-noticebar": true,
        "didi-noticebar-layout-asideicon": iconHtml,
        "didi-noticebar-layout-iconhidden": !iconHtml,
        "didi-noticebar-layout-shadow": isShadowStyle,
        "didi-noticebar-layout-closehidden": !closeIconShow,
        "didi-noticebar-rollingup": rollingUp
      }, className, className));
      ...
      return _react2.default.createElement(
        ...
        iconHtml && _react2.default.createElement(
          'div',
          { className: 'didi-noticebar-aside-icon' },
          iconHtml
        ),
        _react2.default.createElement(
          'div',
          { className: 'didi-noticebar-msg', ref: 'messageRoot' },
          _react2.default.createElement(
            'ul',
            { className: 'didi-noticebar-msg-items', ref: 'messageItemsRoot', style: { "left": "1000px" } },
            this.messageHTML(),
        ...
        closeIconShow && _react2.default.createElement(
          'div',
          { className: 'didi-noticebar-icon-close', onClick: this.hideClick.bind(this) },
  ...
  closeBack: function closeBack() {}, // 关闭后的回调
  duration: .8 // 翻滚动画执行的时间
}, _temp);
