...
var FadeInUp = (_temp = _class = function (_React$Component) {
  ...
  _createClass(FadeInUp, [{
    ...
    value: function render() {
      ...
      return _react2.default.createElement(
        'div',
        { className: cls },
        _react2.default.createElement(_mask2.default, { hidden: this.state.maskHidden, transparent: transparent, onClick: this.closeTips.bind(this) }),
  ...
  closeBtnText: "确定",
  changeFun: function changeFun() {}, // 参数  true 展开 ，false 关闭
  show: true,
  closeShow: true,
