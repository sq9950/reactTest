  ...
  _createClass(Focus, [{
    ...
    value: function componentDidMount() {
      var _props = this.props,
          ...
          loop = _props.loop,
          timer = _props.timer,
          itemsWidthNumber = Number(width.split("px")[0]),
    ...
    key: 'setStyleInit',
    value: function setStyleInit(props) {
      var focusContent = this.refs.focusContent,
          _state = this.state,
          index = _state.index,
    ...
    value: function touchEd(e, poaX) {
      var _state4 = this.state,
          index = _state4.index,
          itemsWidthNumber = _state4.itemsWidthNumber,
          len = _state4.len,
          loop = _state4.loop,
          focusContent = this.refs.focusContent;
    ...
    value: function render() {
      ...
      var cls = (0, _classnames2.default)((_classNames = {}, _defineProperty(_classNames, "jimu-focus-layout", true), _defineProperty(_classNames, className, className), _classNames));
      ...
      return _react2.default.createElement(
        ...
        children.length > 1 ? _react2.default.createElement(
          Swipeable,
          { onSwiping: this.touching.bind(this), onSwipingLeft: this.touchLeft.bind(this), onSwipingRight: this.touchRight.bind(this), onSwiped: this.touchEd.bind(this) },
          loop ? _react2.default.createElement(
            'div',
            { className: 'jimu-focus-content', ref: 'focusContent' },
            children.map(function (re, index) {
              return _react2.default.createElement(
                'div',
                { className: 'jimu-focus-items', style: { width: width }, key: 1 - index },
                re
              );
            }),
            children.map(function (re, index) {
              return _react2.default.createElement(
                'div',
                { className: 'jimu-focus-items', style: { width: width }, key: 2 - index },
                re
              );
            }),
            children.map(function (re, index) {
              return _react2.default.createElement(
                'div',
                { className: 'jimu-focus-items', style: { width: width }, key: 3 - index },
                re
              );
            })
            ...
            children.map(function (re, index) {
              return _react2.default.createElement(
                'div',
                { className: 'jimu-focus-items', style: { width: width }, key: index },
                re
              );
            })
          ),
