  ...
  _createClass(carList, [{
      ...
      return listData.map(function (ele, index) {
        ...
        return _react2.default.createElement(
          ...
          _extends({
            ...
            onClick: _this2.listClick.bind(_this2)
          }, other),
      ...
      return colorData.map(function (ele, index) {
        return _react2.default.createElement(
          'div',
          {
            ...
            'data-obj': JSON.stringify(ele),
            onClick: _this3.colorClick.bind(_this3)
          },
    ...
    value: function render() {
      ...
      var dialogList = _react2.default.createElement(
        ...
        this.initListData.bind(this)(),
        this.initColorData.bind(this)()
      );
      return showWrap ? _react2.default.createElement(
        'div',
        {
          className: 'dialogListWrap',
          onClick: this.wrapClick.bind(this)
        },
        dialogList
      ) : dialogList;
    }
