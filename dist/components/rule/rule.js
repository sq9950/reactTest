...
var Rule = (_temp = _class = function (_React$Component) {
  ...
  _createClass(Rule, [{
    ...
    value: function initDraw(props) {
      ...
      // for (var i = (max - min) / unitAmount ; i >= 0; i--) {
      //   lineArr.push(i)
      // }
    ...
    value: function componentDidMount() {
      // this.initDraw(this.props)
      var stepLayClientWidth = this.refs.stepLay.clientWidth,
          stepTouch = this.refs.stepTouch;
    ...
    value: function setPosLf(value) {
      var _state = this.state,
          ...
          left = (value - min) / unitAmount * unitWidth - this.stepLayClientWidth / 2,
          checkLeft = -left;
    ...
    value: function move(e) {
      var self = this,
          ...
          totle = _state2.totle,
          unitAmount = _state2.unitAmount,
          unitWidth = _state2.unitWidth,
          stepTouch = this.refs.stepTouch,
          stepLayClientWidth = this.refs.stepLay.clientWidth,
          pageX = e.touches[0].pageX - this.startX + this.stepLeft,
          onValue = (min + -(pageX - this.stepLayClientWidth / 2) * unitAmount / unitWidth).toFixed(fixed),
          onLeft = pageX;
    ...
    value: function render() {
      ...
      return _react2.default.createElement(
        'div',
        { className: 'jimu-step-slider', onTouchEnd: this.eventEnd.bind(this), onTouchMove: this.eventMove.bind(this), onTouchStart: this.eventStart.bind(this) },
        _react2.default.createElement(
          'div',
          { className: 'jimu-slider-rule', ref: 'wrapLay' },
          _react2.default.createElement(
            'div',
            ...
            _react2.default.createElement(
              'div',
              { className: 'line-light', ref: 'lineLight' },
        ...
        _react2.default.createElement(
          'div',
          { className: 'step-wrap', ref: 'stepLay' },
          _react2.default.createElement(
            'div',
            { className: 'step-touch', ref: 'stepTouch' },
            _react2.default.createElement(
              'ul',
              { className: 'step-line' },
