...
var PositionSwitch = (_temp = _class = function (_Component) {
  ...
  function PositionSwitch(props) {
    _classCallCheck(this, PositionSwitch);

    return _possibleConstructorReturn(this, (PositionSwitch.__proto__ || Object.getPrototypeOf(PositionSwitch)).call(this, props));
  }
  ...
  _createClass(PositionSwitch, [{
    ...
    value: function transformMove(obj) {
      ...
      if (this.props.children.length !== obj.length) {
        console.error("子元素条数请与orderArr.length一致");
        return;
      }
    ...
    value: function render() {
      ...
      return _react2.default.createElement(
        ...
        children.map(function (re, index) {
          return _react2.default.createElement(
            'div',
            { style: { "width": width + 'px' }, ref: 'move_' + index, className: 'jimu-move-item', key: index },
            re
          );
        })
      );
  ...
  itemsMoveBack: function itemsMoveBack() {} // 自元素位置移动后的回调
}, _temp);
