  ...
  _createClass(Brand, [{
      ...
      if (carArr) {
        ...
        if (!carArr.length) {
          ...
          this.state.firstChar.map(function (char, index) {
            if (carObj[char]) {
              carObj[char].map(function (ele, index) {
              ...
              carObj[a].map(function (ele, index) {
                ...
                return _react2.default.createElement(
                  'div',
                  {
                    ...
                    onClick: self.carClick.bind(self)
                  },
    ...
    value: function initHotCarBrandCon() {
      ...
      var _props2 = this.props,
          ...
          brandStaticURL = _props2.brandStaticURL,
          ...
          hotCarBrandData.map(function (ele, index) {
            ...
            return _react2.default.createElement(
              'li',
              {
                ...
                'data-carid': ele.id,
                onClick: _this2.hotCarBrandClick.bind(_this2)
              },
    ...
    value: function render() {
      ...
      return _react2.default.createElement(
        ...
        _react2.default.createElement(
          ...
          hotCarBrandData ? this.initHotCarBrandCon.bind(this)() : null,
          this.initCarBrandCon.bind(this)()
        ),
