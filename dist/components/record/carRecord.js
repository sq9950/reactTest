...
var CarRecord = (_temp = _class = function (_Component) {
  ...
  function CarRecord(props) {
    ...
    return _possibleConstructorReturn(this, (CarRecord.__proto__ || Object.getPrototypeOf(CarRecord)).call(this, props));
  }
  ...
  _createClass(CarRecord, [{
    ...
    value: function changeName(name) {
      ...
      name = name.length >= fontLen ? name.substr(0, subNum) + '...' : name;
      return name;
    }
    ...
    value: function subFontChar(name) {
      ...
      name = length > num ? name.substr(0, i - 1) + '...' : name;
      return name;
    }
    ...
    value: function render() {
      ...
      return _react2.default.createElement(
        ...
        _react2.default.createElement(
          ...
          _react2.default.createElement('span', { className: 'didi-icon didi-icon-location-point' }),
          _react2.default.createElement(
            'span',
        ...
        _react2.default.createElement(
          'div',
          { className: 'wrapper wrapper-from-hook' },
          _react2.default.createElement('span', { className: 'didi-icon didi-icon-location-point-red' }),
          _react2.default.createElement(
            'span',
            { className: 'fz14 txt-from txt-from-hook default ml5' },
            endName
